...
import utility.GetListOfFiles;

public class emMultipleFileUpload extends TestBase {
	...
	public void SubmitNewManuscript() throws InterruptedException, IOException {
		...
		HashMap<String,String> inputTestDataFoldersInfo = new HashMap <String,String>();
		String FolderName,FolderPath = null;
		...
		String directoryPath="D:\\AutomationFramework";
	    inputTestDataFoldersInfo=GetListOfFiles.listOfDirectories(directoryPath);
	    
	    
	    
	    Set<Entry<String, String>> inputFoldersEntrySet = inputTestDataFoldersInfo.entrySet();
	    
	    System.out.println(inputFoldersEntrySet);
			...
			Utils.switchToFrame("content");
			 ...
			 for (Entry<String, String> FoldersInfo : inputFoldersEntrySet)	
			    {
			    	FolderName=FoldersInfo.getKey();
			        FolderPath=FoldersInfo.getValue();
			        
			        
			        
			        inputTestDataFilesInfo=Utils.listFilesAndFilesSubDirectories(FolderPath);
